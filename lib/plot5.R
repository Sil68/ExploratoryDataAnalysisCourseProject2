...
plot5 <- function(dtPlt=NULL, fname=NULL, imgSize=NULL, cnty="24510") {
        ...
        if (all(!is.na(pltWidth), !is.na(pltHeight), !is.na(pltRes))) {
            ...
            pltData <- function(dtPlt, xfs=1, yfs=1, tfs=0.7, lfs=0.8, lwd=2) {
                ...
                with(dtPlt, {
                    ...
                    title(main="Total emissions from PM2.5 from motor vehicle\nsources in Baltimore City, Maryland", 
                          cex=tfs)
                })
